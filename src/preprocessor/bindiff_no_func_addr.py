...
ida_64_path = os.path.abspath(os.path.join(os.path.realpath(__file__), '../../../../ida8.3-UCSB/idat64'))
ida_32_path = os.path.abspath(os.path.join(os.path.realpath(__file__), '../../../../ida8.3-UCSB/idat'))
